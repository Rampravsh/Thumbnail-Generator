    ...
    try {
      ...
      if (error.status === 429) {
        ...
        if (isDailyQuota) {
            ...
            throw new Error("You have exceeded your daily API quota. Please try again tomorrow.");
        }
        ...
        if (attempt < MAX_RETRIES - 1) {
            ...
            console.log(`Rate limit exceeded. Retrying in ${retryDelay / 1000} seconds... (Attempt ${attempt})`);
      ...
      throw new Error("The AI service is currently unavailable after multiple retries. Please try again later.");
    }
  }
}
